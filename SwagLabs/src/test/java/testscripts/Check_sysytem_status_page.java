...
public class Check_sysytem_status_page 
{
	WebDriver driver;
    @Test
    public void Checking_sysytem_status_page() throws IOException {
    	...
    	ap.subscription(driver);
    	ap.Verify_system_status_page_visible(driver);
      }
}